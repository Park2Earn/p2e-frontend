...
export default function Home() {
  ...
  const [publicGoodsCount, setPublicGoodCount] = useState(0);
  ...
  useEffect(() => {
    async function getAll() {
      setIsLoading(true);
      const proposalCount = await Park2EarnContract.methods
        .getPublicGoodsCount()
        .call(); // returns int
      console.log(proposalCount);
      setPublicGoodCount(proposalCount);
